    ...
    return /* html */ `
        ...
        <header class="text-white h-full w-full rounded-b-md" style="background-image: url(imgs/bg-banner.jpg); ">
                ...
                <div class="px-3 py-6 grid grid-cols-2 justify-between">
                    ...
                    <div class="">
                        <img class="lg:w-ful mx-auto lg:h-full opacity-60 shadow-xl shadow-slate-300 rounded-full cursor-pointer sm:w-3/4 sm:h-3/4" src="../imgs/img_me.png" alt="Couldn't downloaded the image">
                    </div>
                </div>
                <div class="my-6 text-center uppercase tracking-[5px] font-medium text-2xl">
                    <h1>Skills</h1>
                </div>
                <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-none gap-8 mx-3 text-center">
                        ...
                        ${myblogs.map((myblog) => {
                            return `
                                <div class="border p-3 my-6 rounded-md h-[250px] grid items-center pointer-events-auto hover:bg-gray-700 hover:bg-opacity-30 hover:border-none">
